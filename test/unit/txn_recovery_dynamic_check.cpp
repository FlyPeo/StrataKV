/*
 * Focused verification for OpenSpec change add-region-epoch-and-dynamic-routing
 * task 3.1: TxnRecoveryManager resolves current Region routes instead of the
 * startup catalog, and concurrent Region unregister + recovery completes
 * without dangling access or deadlock.
 */
#include <atomic>
#include <chrono>
#include <iostream>
