// Request-envelope compatibility matrix:
//   new client  -> new server          (typed header accepted)
//   legacy client -> static server     (headerless accepted in static mode)
//   any client  -> dynamic server      (headerless rejected with MISSING_HEADER)
//   structured errors                  (fallback to legacy string errors)
#include <iostream>
#include <stdexcept>
#include <string>
#include <vector>
